# Insertion Methods Documentation

This folder contains documentation for DOM insertion and manipulation methods.
...
## Wrapping
- **[wrap()](./wrap.md)** - Wrap each element individually
