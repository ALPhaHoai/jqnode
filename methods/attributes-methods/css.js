 ...
 * @returns {string|Object|JQ} Property value(s) if getting, JQ instance if setting
 */
module.exports = function css(prop, value) {
    ...
    if (value === undefined && (typeof prop !== 'object' || Array.isArray(prop))) {
        ...
        if (Array.isArray(prop)) {
            ...
            prop.forEach(function (property) {
                result[property] = getComputedStyleValue(element, property);
            });
            return result;
        }
