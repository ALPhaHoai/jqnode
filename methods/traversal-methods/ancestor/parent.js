...
function parent(selector) {
    this.debugLog(`JQ.parent: Finding parents for ${this.nodes.length} elements, selector: ${selector || 'none'}`);
    ...
    this.debugLog(`JQ.parent: Found ${resultNodes.length} parent elements`);
