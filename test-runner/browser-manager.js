...
class BrowserManager {
    ...
    async runMCPBrowserTest(fileName) {
        ...
        try {
            ...
            const result = {
                ...
                mismatch:
                    (parseInt(nqPassed) || 0) !== (parseInt(jqPassed) || 0) ||
    ...
    async runPlaywrightBrowserTest(fileName) {
        ...
        try {
            ...
            await this.playwrightWaitForFunction(
                page,
                () => {
            ...
            const result = {
                file: fileName,
                nodeQuery: {
                    total: parseInt(nqTotal),
                    passed: parseInt(nqPassed),
                    failed: parseInt(nqFailed),
                },
                jQuery: {
                    total: parseInt(jqTotal),
                    passed: parseInt(jqPassed),
                    failed: parseInt(jqFailed),
                },
                consoleErrors: consoleErrors,
                failedTests: failedTests,
