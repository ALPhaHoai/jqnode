...
describe('Additional selector tests', () => {
    ...
    describe('Real-world jQuery usage patterns', () => {
      ...
      `;
            ...
            // Filter by category
            const electronics = products.nodes.filter(node =>
                node.attributes['data-category'] === 'electronics'
            );
            const books = products.nodes.filter(node =>
            ...
            const visibleProducts = products.nodes.filter(node =>
      ...
      `;
            ...
            toggles.nodes.forEach((toggle, index) => {
